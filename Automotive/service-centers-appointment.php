    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="new-advertisement.php" class="nav-link px-2 text-white">Add Advertisments</a></li>
                <li><a href="service-center-register.php" class="nav-link px-2 text-white">Service center register</a></li>
                <li><a href="service-centers-appointment.php" class="nav-link px-2 text-white">Appointments</a></li>
            </ul>
